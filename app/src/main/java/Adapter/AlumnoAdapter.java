...
public class AlumnoAdapter extends RecyclerView.Adapter<AlumnoAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull ViewHolder holder, int position) {
        ...
        holder.txtCurso.setText(alumno.getCurso());
    ...
    @Override
    public int getItemCount() { return listaAlumno.size(); }
    ...
    private void mostrarDialogoEditarAlumnos(Context context, Alumno alumno, AlumnoAdapter.ViewHolder holder) {
        ...
        ArrayAdapter<String> adapterGenero = new ArrayAdapter<>(context, android.R.layout.simple_spinner_item, generos);
