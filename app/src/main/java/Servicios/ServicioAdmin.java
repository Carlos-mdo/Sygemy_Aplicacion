...
public class ServicioAdmin {
    ...
    public ServicioAdmin(Context context){
        ...
        admin = new AdminSQLiteOpenHelper(context, "administracion", null, 1);
        base_Datos = admin.getWritableDatabase();
    }

    public boolean buscarAdmin(EditText etUsuario, EditText etContrasenia) {

        adminRegis.put("usuario","admin");
        adminRegis.put("contrasenia","admin123");
        adminRegis.put("rol","admin");

        base_Datos.insert("usuarios",null,adminRegis);
